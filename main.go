...
func main() {
	...
	route.HandleFunc("/project/delete/{id}", projectDelete).Methods("GET")
	route.HandleFunc("/project/edit/{id}", projectEdit).Methods("GET")
	route.HandleFunc("/project/edit/{id}", projectEditPost).Methods("POST")
